...
"""
    ...
    expected = {
        ...
        "actor_layers": getattr(run, "actor_layers", 3),
        "actor_units": getattr(run, "actor_units", 1024),
        "actor_lr": 3e-5,
        "critic_lr": 3e-5,
        "local_world_warmup": getattr(run, "world_warmup", 1000),
        "joint_world_warmup": getattr(run, "world_warmup", 1000),
