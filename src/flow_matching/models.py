...
# SwiGLU MoE, time-agnostic. See flow_matching.paths for the time-dependent block-diffusion attention mask,
# the eq-3 block-diffusion attention mask, flow_matching.train for the BDLM loss
# and WSD curriculum, and flow_matching.simulate for the block-by-block sampler.
...
class BlockDiffusionTransformer(nn.Module):
    ...
    def __call__(
        ...
        *,
        ...
        from flow_matching.paths import block_diffusion_attention_mask
