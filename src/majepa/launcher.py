"""Launch a reproducible MA-JEPA training run."""
...
def run_training(
    ...
    *,
    ...
    """Run MA-JEPA with pinned Embodied infrastructure."""
    ...
    if not spec.python.exists():
        raise FileNotFoundError(f"MA-JEPA Python is missing: {spec.python}")
