...
def load_checkpoint_policy(
    ...
    *,
    ...
    if (
        ...
        and int(expected_action_dim) != adapter.action_dim
    ):
        raise ValueError(
    ...
    if (
        expected_num_agents is not None
        and int(expected_num_agents) != adapter.num_agents
    ):
        raise ValueError(
    ...
    if expected_observation_shape is not None:
        expected_observation_shape = tuple(
            int(dim) for dim in expected_observation_shape
        )
