...
class MARLCore(TeamAxisAdapter, LocalAgent):
    ...
    def __init__(self, obs_space, act_space, config):
        ...
        if self.ctde_teammate_belief_enabled and self.actor_trust_enabled:
            raise ValueError(
    ...
    def imagination_starts(
        ...
        # Ended episodes are not valid roots for imagined policy gradients.
        # This includes wins, losses, and episode-limit transitions.
